...
For the staged v0.9.0 public release audited on 2026-08-16, `npm audit --omit=dev` reported 0 Critical, 0 High, and 2 Moderate findings for the shipped runtime dependency set. The full source-development installation, including development dependencies, reported 1 Critical, 1 High, and 5 Moderate findings. The development-toolchain findings are known and are not a v0.9.0 release blocker; they are not part of normal installed-VSIX runtime use.
