...
- a public, sanitized copy of these documents; and
...
- any file that references an internal path, an undisclosed security issue, a benchmark result, customer data, or a private service.
