...
**Public Beta maintenance update.** TokenLighten v0.12.1 addresses dependency, static-analysis, and source-quality findings discovered after v0.12.0. It does not introduce a new performance feature.
